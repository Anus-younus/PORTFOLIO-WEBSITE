  ...
  return (
    ...
    >
      <div className='h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48'>
        {/* TEXT CONTAINER */}
        <div className='h-1/2 lg:h-full lg:w-1/2 flex items-center justify-center text-5xl xl:text-6xl'>
          <div>
        ...
        {/* FORM CONTAINER */}
        <form className='h-[70%] lg:h-full lg:w-1/2 bg-red-50 rounded-xl text-xl flex flex-col gap-8 justify-center p-12 xl:p-24'>
          <span>Dear Anas Younus</span>
          <textarea
          rows={6} 
